...
if (isset($content)) {
  $c = $content;
  if (strpos($c, 'pages/docs/backend.php') !== false) $dest = '#init';
  elseif (strpos($c, 'pages/docs/frontend.php') !== false) $dest = '#frontend-intro';
  elseif (strpos($c, 'pages/docs/api.php') !== false) $dest = '#api-intro';
  elseif (strpos($c, 'pages/forms/contact.php') !== false) $dest = '#';
  elseif (strpos($c, 'pages/forms/subscribe.php') !== false) $dest = '#';
  elseif (strpos($c, 'pages/forms/issue.php') !== false) $dest = '#';
  elseif (strpos($c, 'pages/forms/admin.php') !== false) $dest = '#';
}
?>
<section class="overflow-hidden bg-slate-900">
  <div class="py-16 sm:px-2 lg:relative lg:px-0 lg:py-20">
    <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-7xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
      <div class="relative z-10 md:text-center lg:text-left">
        <img alt="" width="530" height="530" decoding="async" data-nimg="1" class="absolute right-full bottom-full -mr-72 -mb-56 opacity-50" style="color:transparent" src="https://syntax.tailwindui.com/_next/static/media/blur-cyan.d28a5585.png">
        <div class="relative">
          <p class="inline bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-bold text-5xl tracking-tight text-transparent">Ne ratez plus jamais le cache.</p>
          <p class="mt-4 text-2xl tracking-tight text-slate-400">Mettez en cache absolument tout ce que votre application pourrait faire à l'avance, pour que votre code n'ait même jamais besoin d'être exécuté.</p>
          <div class="mt-8 flex gap-4 md:justify-center lg:justify-start">
            <a class="rounded-full bg-sky-300 py-2 px-4 text-sm font-semibold text-slate-900 hover:bg-sky-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-300/50 active:bg-sky-500" href="<?= $dest ?>">Get started</a>
            <a class="rounded-full bg-slate-800 py-2 px-4 text-sm font-medium text-white hover:bg-slate-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/50 active:text-slate-400" href="https://github.com/" target="_blank">View on GitHub</a>
          </div>
        </div>
      </div>
      <div class="relative lg:static xl:pl-10">
        <div class="absolute inset-x-[-50vw] -top-32 -bottom-48 mask-[linear-gradient(transparent,white,white)] lg:-top-32 lg:right-0 lg:-bottom-32 lg:left-[calc(50%+14rem)] lg:mask-none dark:mask-[linear-gradient(transparent,white,transparent)] lg:dark:mask-[linear-gradient(white,white,transparent)]"><svg aria-hidden="true" viewBox="0 0 668 1069" width="668" height="1069" fill="none" class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-0 lg:translate-x-0 lg:translate-y-[-60%]">
            <defs>
              <clipPath id="_r_l_-clip-path">
                <path fill="#fff" transform="rotate(-180 334 534.4)" d="M0 0h668v1068.8H0z"></path>
              </clipPath>
            </defs>
            <g opacity=".4" clip-path="url(#_r_l_-clip-path)" stroke-width="4">
        ...
        <div class="relative"><img alt="" width="530" height="530" decoding="async" data-nimg="1" class="absolute -top-64 -right-64" src="https://syntax.tailwindui.com/_next/static/media/blur-cyan.d28a5585.png" style="color: transparent;"><img alt="" width="567" height="567" decoding="async" data-nimg="1" class="absolute -right-44 -bottom-40" src="https://syntax.tailwindui.com/_next/static/media/blur-indigo.b752cf77.png" style="color: transparent;">
          ...
          <div class="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur-sm">
            ...
            <div class="pt-4 pl-4"><svg aria-hidden="true" viewBox="0 0 42 10" fill="none" class="h-2.5 w-auto stroke-slate-500/30">
              ...
              <div class="mt-4 flex space-x-2 text-xs">
                <div class="flex h-6 rounded-full bg-linear-to-r from-sky-400/30 via-sky-400 to-sky-400/30 p-px font-medium text-sky-300">
                  <div class="flex items-center rounded-full px-2.5 bg-slate-800">cache-advance.config.js</div>
                </div>
